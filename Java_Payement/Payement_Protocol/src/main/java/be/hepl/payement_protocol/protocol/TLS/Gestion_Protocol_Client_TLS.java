 ...
 */
package be.hepl.payement_protocol.protocol.TLS;

import be.hepl.payement_protocol.protocol.Secured.*;
 ...
 * @author Sirac
 */
public class Gestion_Protocol_Client_TLS extends Gestion_Protocol_Client {
    ...
    public Gestion_Protocol_Client_TLS(Socket sock, Properties config) throws IOException, KeyStoreException, CertificateException, NoSuchAlgorithmException {
        super(sock, config);
    ...
    public void SendLogout(String Login) throws Exception {
        try {
            ...
            try {
                ...
                Logger.getLogger(Gestion_Protocol_Client_TLS.class.getName()).log(Level.SEVERE, null, ex);
            }
            currentUser = null;
        } catch (Exception ex) {
            throw new Exception("ENDCONNEXION", ex);
