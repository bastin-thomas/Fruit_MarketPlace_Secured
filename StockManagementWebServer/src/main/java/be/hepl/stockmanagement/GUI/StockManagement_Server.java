 ...
 * @author Arkios
 */
public class StockManagement_Server extends javax.swing.JFrame implements Logger {
    ...
    private void initComponents() {
        ...
        Port_Spinner.setModel(new javax.swing.SpinnerNumberModel(80, 80, 89, 1));
    ...
    private void Start_Stop_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Start_Stop_ButtonActionPerformed
        ...
        {     
            ...
            try
            {
                db = new DBStock(DBurl_TextField.getText(), this);
            }
            catch(Exception ex)
            {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StockManagement_Server().setVisible(true);
            }
        });
    }
    // </editor-fold>
